...
namespace KFlearning.Core.Installer
{
    public class TaskGraph : ITaskGraph
    {
        ...
        public TaskGraph(IProgressBroker progressBroker, IModuleService moduleService, IPathManager path)
        {
        ...
        {
            var idePath = _path.GetModuleInstallPath(ModuleKind.Ide);
            return Directory.Exists(idePath);
        }
