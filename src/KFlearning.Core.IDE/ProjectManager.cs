...
namespace KFlearning.Core.IDE
{
    public class ProjectManager : IProjectManager
    {
        ...
        public ProjectManager(IPathService pathService, IDatabaseContext database, IProjectHandler projectHandler,
            IFileSystemManager fileSystem, IPathManager pathManager)
        {
        ...
        public void Purge()
        {
            var dirs = Directory.EnumerateDirectories(_pathManager.GetModuleInstallPath(ModuleKind.ReposDirectory), "*",
        ...
        {
            return Path.Combine(_pathManager.GetModuleInstallPath(ModuleKind.ReposDirectory),
